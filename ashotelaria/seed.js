...
function createSeed(today = "2026-07-14") {
  return {
    ...
    rooms: [
      ...
      { id: "room-103", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-standard-jurua", number: "103", status: "inspected" },
      { id: "room-104", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-standard-jurua", number: "104", status: "dirty" },
      { id: "room-201", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-superior-jurua", number: "201", status: "occupied" },
      { id: "room-202", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-superior-jurua", number: "202", status: "available" },
      { id: "room-203", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-superior-jurua", number: "203", status: "maintenance" },
      { id: "room-204", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-superior-jurua", number: "204", status: "inspected" },
      { id: "room-301", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-family-suite-jurua", number: "301", status: "dirty" },
      { id: "room-302", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-family-suite-jurua", number: "302", status: "available" },
      { id: "room-303", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-family-suite-jurua", number: "303", status: "blocked" },
      { id: "room-304", tenantId: "tenant-czs", propertyId: "property-jurua-palace", roomTypeId: "room-type-family-suite-jurua", number: "304", status: "available" },
