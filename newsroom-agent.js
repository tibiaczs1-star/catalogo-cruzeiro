...
(function () {
  ...
  function createOfficeWidget() {
    ...
    root.innerHTML = `
      <div class="agente-escritorio-head">Central de Agentes • monitorando notícias</div>
      <div class="agente-escritorio-body">
        <div class="agente-estacao"><div class="agente-monitor"></div><div class="agente-boneco"></div></div>
        <div class="agente-estacao"><div class="agente-monitor"></div><div class="agente-boneco"></div></div>
        <div class="agente-estacao"><div class="agente-monitor"></div><div class="agente-boneco"></div></div>
      </div>
    `;
