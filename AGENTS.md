...
- Para arte de personagens/pedestres PubPaid 2, seguir `PUBPAID_V2_NPC_PIXEL_ART_MASTER_PROMPT.md` e `PUBPAID_2_CHARACTER_ART_PROMPT.md`, entregar primeiro em HTML simples de aprovacao e nao mexer no runtime final.
