...
```mermaid
xychart-beta
    title "Tracao inicial do Catálogo CZS Jornal"
    x-axis ["Views 3 dias", "Seguidores", "Posts Instagram", "Stories 31/05"]
    y-axis "Quantidade" 0 --> 9000
    bar [9000, 552, 181, 23]
```
...
```mermaid
xychart-beta
    title "Projecao mensal baseada na arrancada inicial"
    x-axis ["Conservador", "Realista", "Agressivo"]
    y-axis "Views por mes" 0 --> 90000
    bar [31500, 54000, 90000]
```
...
```mermaid
pie title Receita potencial do ecossistema
    "Publicidade local e cotas" : 42
    "Servicos digitais" : 26
    "Classificados e comercio" : 18
    "Jogos promocionais / PubPaid" : 14
```
