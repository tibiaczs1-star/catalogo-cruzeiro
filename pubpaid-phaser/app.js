...
import { bindDomGameInterface } from "./ui/domGameInterface.js?v=20260520-polishcam2";
import { bindWalletInterface } from "./ui/walletInterface.js?v=20260520-polishcam2";
import { closePanel } from "./ui/panelActions.js";
import { savePubpaidProfile, syncPubpaidAccount, syncPubpaidProfile } from "./services/accountService.js?v=20260520-polishcam2";
import { BootScene } from "./scenes/BootScene.js?v=20260520-polishcam2";
import { IntroScene } from "./scenes/IntroScene.js?v=20260520-polishcam2";
import { CharacterSelectScene } from "./scenes/CharacterSelectScene.js?v=20260520-polishcam2";
import { StreetScene } from "./scenes/StreetScene.js?v=20260520-polishcam2";
import { InteriorScene } from "./scenes/InteriorScene.js?v=20260520-polishcam2";
import { GameLobbyScene } from "./scenes/GameLobbyScene.js?v=20260520-polishcam2";
import { PoolGameScene } from "./scenes/PoolGameScene.js?v=20260520-polishcam2";
import { CheckersGameScene } from "./scenes/CheckersGameScene.js?v=20260520-polishcam2";
import { UIScene } from "./scenes/UIScene.js?v=20260520-polishcam2";

const PUBPAID_BUILD_VERSION = "20260520-polishcam2";
