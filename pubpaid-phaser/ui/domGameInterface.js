...
import { joinPubpaidPvpQueue, leavePubpaidPvpQueue, syncPubpaidAccount } from "../services/accountService.js?v=20260522-pubpaidfix9";
import {
  choosePoolSetup,
  confirmPvpReady,
  drawPoker,
  ...
  playTrucoCard,
  shootPool
} from "../services/pvpService.js?v=20260522-pubpaidfix9";
import {
...
} from "../services/tournamentService.js?v=20260522-pubpaidfix9";
import {
  CHECKERS_SIZE,
  applyCheckersMove,
  countCheckersPieces,
  ...
  getCheckersOutcome,
  isCheckersKing
} from "../core/checkersRules.js?v=20260522-pubpaidfix9";
import { Chess } from "../vendor/chess.js?v=20260522-pubpaidfix9";
...
export function bindDomGameInterface(game) {
  ...
  const renderCheckersCoinFlip = (match = {}, demoMode = false) => {
    ...
    if (opening) {
      const buildVersion = window.pubpaidBuildVersion || "20260522-pubpaidfix9";
