...
- Cache/versionamento atual: `20260608-norte-news-v63` em `index.html` e `assets/v8-final/v8-merge-ready.js`.
...
- Validação local feita em `http://localhost:3001/?skipIntro=1&fresh=20260608-norte-news-v63`: HTML 200 com `total=620`, links do WhatsApp renderizados e capturas em `.codex-temp/norte-v63/`.
